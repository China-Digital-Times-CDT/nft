<template>
  <div class="container">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-9 me-auto">
          <div class="footer-item mb-5 mb-lg-0">
            <p class="my-4 footer-para" v-if="SectionData.footerData.content">
              {{ SectionData.footerData.content }}
            </p>
          </div>
          <!-- end footer-item -->
        </div>
        ...
        <div class="col-lg-8">
          <div class="row g-gs">
            <div
              ...
              v-for="item in SectionData.footerData.footerList"
              :key="item.id"
            >
    ...
    <div
      class="copyright-wrap d-flex flex-wrap py-3 align-items-center justify-content-between"
    >
